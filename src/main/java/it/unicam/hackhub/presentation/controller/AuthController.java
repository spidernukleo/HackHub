...
public class AuthController {
    ...
    public ResponseEntity<Void> deleteAccount(@Valid @RequestBody PasswordConfirmationRequest dto, Authentication authentication) {
        authService.deleteAccount(authentication.getName(), dto);
